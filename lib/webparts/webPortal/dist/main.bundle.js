exports["WebPortalContainerBundle"] =
...
var _typeof3 = __webpack_require__(2);
...
var _freeze = __webpack_require__(71);
...
var _getOwnPropertySymbols = __webpack_require__(73);
...
var global = __webpack_require__(8),
    ...
    each = __webpack_require__(134)(0),
    DESCRIPTORS = __webpack_require__(6);
...
function _getUniformDispatcher(stores) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    for (var _iterator = stores, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
      var _ref;
  ...
  createElement: function createElement(type, props, children) {
    ...
    if (!validType) {
      if (typeof type !== 'function' && typeof type !== 'string') {
        ...
        process.env.NODE_ENV !== 'production' ? warning(false, 'React.createElement: type is invalid -- expected a string (for ' + 'built-in components) or a class/function (for composite ' + 'components) but got: %s.%s', type == null ? type : typeof type === 'undefined' ? 'undefined' : (0, _typeof3.default)(type), info) : void 0;
      }
    }
...
module.exports.Store = __webpack_require__(95);
...
$export($export.S + $export.F * !__webpack_require__(141)(function (iter) {
...
var fbemitter = {
  ...
  EmitterSubscription: __webpack_require__(94)
};
...
var EmitterSubscription = __webpack_require__(94);
...
var BaseEventEmitter = function () {
  ...
  BaseEventEmitter.prototype.emit = function emit(eventType) {
    var subscriptions = this._subscriber.getSubscriptionsForType(eventType);
    if (subscriptions) {
      var keys = (0, _keys2.default)(subscriptions);
...
var FluxContainerSubscriptions = __webpack_require__(175);
...
var FluxStoreGroup = __webpack_require__(96);
...
function FluxMixinLegacy(stores) {
  ...
  return {
    ...
    componentWillUnmount: function componentWillUnmount() {
      ...
      for (var _iterator = this._fluxMixinSubscriptions, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3.default)(_iterator);;) {
        var _ref;
...
var FluxStore = __webpack_require__(95);
...
var WebPortalContainer = function (_React$Component) {
    (0, _inherits3.default)(WebPortalContainer, _React$Component);

    function WebPortalContainer() {
        (0, _classCallCheck3.default)(this, WebPortalContainer);
        return (0, _possibleConstructorReturn3.default)(this, (WebPortalContainer.__proto__ || (0, _getPrototypeOf2.default)(WebPortalContainer)).apply(this, arguments));
    }

    (0, _createClass3.default)(WebPortalContainer, [{
        key: 'render',
...
exports.default = _utils2.default.Container.create(WebPortalContainer, { withProps: true });
